    ...
    <Container>
      ...
      <main>
        ...
        <Section id="about" title="Sobre" setActiveSection={setActiveSection}>
          ...
          <p>
            Minhas principais habilidades incluem HTML5, CSS3, JavaScript, React.js, TypeScript, Sass, Styled Components, Bootstrap, Tailwind CSS e VTEX IO. Embora meu foco seja me especializar no front-end, já tive a oportunidade de trabalhar com o back-end de algumas aplicações, utilizando Node.js, MySQL, PostgreSQL, TypeORM e Firebase.
          </p>
          <Skills>
