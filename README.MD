...
A aplicação está disponível para uso [aqui](https://https://philipef-dev-portfolio.vercel.app). Você também pode executá-la em sua máquina localmente. Certifique-se de ter o `Node.js` e o `npm` instalados antes de prosseguir com as etapas abaixo:
